    ...
    for t in parsed.filter_templates():
        ...
        if tn in sv_verb_templates_with_plural_of and tn in all_templates:
            ...
            if plural_of:
                ...
                templates_to_replace.append(
                    (origt, newt, "move plural of= in {{%s}} to {{sv-obs verb pl}} outside of template" % tn)
                )
        ...
        if tn in sv_noun_templates_with_obsoleted_by and tn in all_templates:
            ...
            if obsoleted_by:
                ...
                templates_to_replace.append(
                    (origt, newt, "move plural of= in {{%s}} to {{sv-obs noun form}} outside of template" % tn)
                )
            ...
            if comp_of or sup_of:
                ...
                templates_to_replace.append(
                    (
                        origt,
                        newt,
                        "move comp-of=/sup-of== in {{%s}} to {{nc comp of}}/{{nc sup of}} outside of template" % tn,
                    )
                )
        ...
        if tn in el_templates_with_active and tn in all_templates:
            ...
            if active:
                ...
                templates_to_replace.append(
                    (origt, newt, "move active= in {{%s}} to {{nc pass of}} outside of template" % tn)
                )

...
def singularizable(word):
    return (
        word in singularize_as_such
        or (word.endswith("s") and not word.endswith("ss") and not word.endswith("'s") and word not in dont_singularize)
        or (not word.endswith("thing") and re.search("^.*[aeiou].*ing$", word))
    )

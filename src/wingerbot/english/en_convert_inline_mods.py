...
recognized_label_adverbs = {
  "now", "mostly", "chiefly", "all", "both", "more", "less", "somewhat", "sometimes", "also", "especially", "possibly",
  "otherwise", "often", "mainly", "very", "extremely",
}
...
recognized_labels = {
  "rare", "uncommon", "common", "colloquial", "informal", "nonstandard", "non-standard", "offensive",
  ...
  "collective",
  "dialectal", "regional", "poetic", "uncertain", "honorific", "nickname", "pejorative", "humorous", "eye dialect",
  "proscribed", "hypercorrect", "official", "misconstruction",
  ...
  "US", "American", "North America", "Canada", "Canadian", "UK", "British", "Britain", "British English", "Scotland",
  "Australia", "Australian", "Ireland", "Irish", "New Zealand", "Indian English", "AU", "NZ", "Commonwealth",
  "Quebec", "Geordie", "England",
  ...
  "chemistry", "architecture", "phonetics", "biology", "astronomy", "computing", "Internet", "baseball",
  "nautical", "jewelry", "heraldry",
}
...
recognized_pos = {
  ...
  "agent noun", "na", "ni", "vai", "vii", "vti", "vta", "instrumental nouns", "instrumental noun", "action noun",
  "gerund",
}
    ...
    for t in parsed.filter_templates():
      for param in t.params:
        ...
        if "qual" in pn:
          ...
          if not m:
            pagemsg("WARNING: Internal error: Didn't correctly convert qualifier to inline modifier but saw %s" %
                    inline_mod)
            continue
          modtype = m.group(1)
...
parser = blib.create_argparser("Convert {{en-noun}} and {{en-verb}} to use inline modifiers",

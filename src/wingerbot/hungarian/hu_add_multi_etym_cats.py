...
hu_lemma_mapping = {"suffix": "morpheme", "prefix": "morpheme", "interfix": "morpheme", "clitic": "morpheme"}
hu_nonlemma_forms = [
    "adjective form",
    "adverb form",
    "determiner form",
            ...
            for posk in poses_seen_per_section[k]:
                for posl in poses_seen_per_section[l]:
                    if posk in hu_nonlemma_forms and posl in hu_lemmas:
                        ...
                        posk in hu_lemmas
                        and posl in hu_lemmas
                        or posk in hu_nonlemma_forms
                        and posl in hu_nonlemma_forms
                    ) and posk > posl:
                        pairs_seen.add((posl, posk))
                    else:
...
parser = blib.create_argparser(
    "Add multi-lemma categories to Hungarian terms", include_pagefile=True, include_stdin=True
)

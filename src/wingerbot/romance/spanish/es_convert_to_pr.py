                        ...
                        if getparam(hmpt, "1") != "es":
                            ...
                            for param in hmpt.params:
                                ...
                                def normalize_homophone_qualifier(q):
                                    q = re.sub(
                                        "(non-Castilian|non-Iberian|seseo and ceceo|seseo|Latin-America|in dialects without distinción|in dialects without distinction between S and Z|non-\[*distinción\]*)",
                                        "Latin America",
                                        q,
                                    )

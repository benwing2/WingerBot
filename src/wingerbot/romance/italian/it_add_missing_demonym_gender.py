...
parser = blib.create_argparser(
    "Add missing gender to {{demonym-noun|it}} as needed and check for misspecified genders",
...
blib.do_pagefile_cats_refs(
    args, start, end, process_text_on_page, default_refs=["Template:demonym-noun"]
)

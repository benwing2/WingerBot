        ...
        if tn in ["it-verb"]:
            ...
            if pagetitle.endswith("re"):
                ...
                if it_verb_t is not None:
                    pagemsg("WARNING: Saw two {{it-verb}} templates, skipping: %s and %s" % (str(it_verb_t), str(t)))
                    return
                it_verb_t = t
                param1 = getp("1")
                if param1:
            ...
            if it_conj_t is not None:
                pagemsg("WARNING: Saw two {{it-conj-*}} templates, skipping: %s and %s" % (str(it_conj_t), str(t)))
                return
            it_conj_t = t

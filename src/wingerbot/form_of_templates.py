...
form_of_templates = [
    ...
    (
        "alternative form of",
        {"aliases": ["alt form", "altform"], "deprecated-aliases": ["alt form of"], "withcap": True, "withfrom": True},
    ),
    ...
    (
        "diminutive of",
        {"aliases": ["dim of"], "withPOS": True, "cat": "diminutive {{pluralize|{{{p|{{{POS|noun}}}}}}}}"},
    ),
    ...
    (
        ...
        {"withPOS": True, "cat": ["diminutive {{pluralize|{{{p|{{{POS|noun}}}}}}}}", "endearing terms"]},
    ),
    ...
    (
        ...
        {"aliases": ["honor alt case"], "withcap": True},
    ),  # FIXME, rewrite with withdot=
    ...
    (
        ...
        {"withcap": True, "withdot": True, "withfrom": True, "cat": "pronunciation spellings"},
    ),

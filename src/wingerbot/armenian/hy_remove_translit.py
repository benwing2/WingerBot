...
def remove_translit(params, start, end):
            ...
            def doparam(param, value=None):
                ...
                if matches_value:
                    ...
                    if val == "-":
                        ...
                        pagemsg("Not removing %s=%s from page in to-ignore category: %s" % (param, val, str(t)))
    ...
    def get_langs_to_do():
        ...
        long_langs2do = [langs_with_override_translit_map[x] for x in langs2do]
    ...
    for category in yield_cats():
        ...
        for index, page in blib.cat_articles(category, start, end):
            if page.title() not in pages_to_ignore:
                blib.do_edit(index, page, remove_translit_one_page, save=params.save, verbose=params.verbose)

...
special_comparative_ending_tags = {key: [tag + "|comd" for tag in value] for key, value in positive_ending_tags.items()}
...
special_superlative_ending_tags = {key: [tag + "|supd" for tag in value] for key, value in positive_ending_tags.items()}

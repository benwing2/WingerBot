    ...
    def combine_doublets(m):
        ...
        for t in rest.filter_templates(recursive=False):
            ...
            for param in t.params:
                ...
                elif pname in ["t1", "gloss1", "tr1", "ts1", "pos1", "lit1", "alt1", "sc1", "id1", "g1"]:
...
parser = blib.create_argparser("Combine adjacent doublets", include_pagefile=True, include_stdin=True)

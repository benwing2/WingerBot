...
uk_decl_noun_unc_slots = ["nom_s", "gen_s", "dat_s", "acc_s", "ins_s", "loc_s", "voc_s"]
uk_decl_noun_pl_slots = ["nom_p", "gen_p", "dat_p", "acc_p", "ins_p", "loc_p", "voc_p"]
be_decl_noun_slots = [
    "nom_s",
    "nom_p",
    "gen_s",
...
be_decl_noun_unc_slots = ["nom_s", "gen_s", "dat_s", "acc_s", "ins_s", "loc_s", "voc_s"]

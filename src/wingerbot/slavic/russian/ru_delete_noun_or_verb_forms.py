...
parser = blib.create_argparser("Delete erroneously created Russian noun or verb forms given the inflection templates that led to those forms being created")

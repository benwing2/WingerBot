    ...
    if headword_tr:
        ...
        for decl_template in decl_templates:
            ...
            if "//" in lemmaval:
                ...
                pagemsg("Replacing decl %s with %s" % (orig_decl_template, str(decl_template)))
...
parser = blib.create_argparser(
    "Convert ru-noun to ru-noun+, ru-proper noun to ru-proper noun+", include_pagefile=True, include_stdin=True
)

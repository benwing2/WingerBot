...
parser = blib.create_argparser("Remove redundant 'Russian nouns' or 'Russian proper nouns' category",
...
blib.do_pagefile_cats_refs(args, start, end, process_text_on_page_noun,
    edit=True, stdin=True, default_refs=["Template:ru-noun", "Template:ru-noun+"])
blib.do_pagefile_cats_refs(args, start, end, process_text_on_page_proper_noun,
    edit=True, stdin=True, default_refs=["Template:ru-proper noun", "Template:ru-proper noun+"])

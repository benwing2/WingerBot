...
def process_text_on_page(index, pagetitle, text):
    ...
    # defns
    newsec = re.sub(
        r"^# \{\{inflection of\|(.*?)\|present or future\|(.*?)\}\}$",
    ...
    newsec = re.sub(
        r"(# |\()'*(present|past) participle (active|passive|adverbial) of'* '*(?:\[\[|\{\{[lm]\|ru\||\{\{term\|)([^|]*?)(?:\]\]|\}\}|\|+lang=ru\}\})'*",
        add_participle_inflection_of,
        secbody,
        0,
        re.I,
    )
    newsec = re.sub(
        r"(# |\()'*(present|past) (active|passive|adverbial) participle of'* '*(?:\[\[|\{\{[lm]\|ru\||\{\{term\|)([^|]*?)(?:\]\]|\}\}|\|+lang=ru\}\})'*",
        add_participle_inflection_of,
        newsec,
        0,
        re.I,
    ...
    def add_past_inflection_of(m):
        ...
        lemma = m.group(3)
        retval = prefix + "{{inflection of|lang=ru|%s||%s%s|past|ind}}" % (
            lemma,
            gender,
            gender != "p" and "|s" or "",
        )
    ...
    newsec = re.sub(
        r"(# |\()'*(male|masculine|female|feminine|neutral|neuter|plural) (?:singular |)past (?:tense |form |)of'* '*(?:\[\[|\{\{[lm]\|ru\||\{\{term\|)([^|]*?)(?:\]\]|\}\}|\|+lang=ru\}\})'*",
        add_past_inflection_of,
        secbody,
        0,
        re.I,
    )
    newsec = re.sub(
        r"(# |\()'*past(?:-tense| tense|) (male|masculine|female|feminine|neutral|neuter|plural) (?:singular |)(?:form |)of'* '*(?:\[\[|\{\{[lm]\|ru\||\{\{term\|)([^|]*?)(?:\]\]|\}\}|\|+lang=ru\}\})'*",
        add_past_inflection_of,
        newsec,
        0,
        re.I,
    ...
    newsec = re.sub(
        r"(# |\()'*(singular|plural) imperative (?:form |)of'* '*(?:\[\[|\{\{[lm]\|ru\||\{\{term\|)([^|]*?)(?:\]\]|\}\}|\|+lang=ru\}\})'*",
        add_imper_inflection_of,
        secbody,
        0,
        re.I,
    )
    newsec = re.sub(
        r"(# |\()'*imperative (singular|plural) (?:form |)of'* '*(?:\[\[|\{\{[lm]\|ru\||\{\{term\|)([^|]*?)(?:\]\]|\}\}|\|+lang=ru\}\})'*",
        add_imper_inflection_of,
        newsec,
        0,
        re.I,
    ...
    newsec = re.sub(
        r"(# |\()'*(1st|2nd|3rd)(?:-person| person|) (singular|plural) (present|future) (?:tense |)of'* '*(?:\[\[|\{\{[lm]\|ru\||\{\{term\|)([^|]*?)(?:\]\]|\}\}|\|+lang=ru\}\})'*",
        add_pres_fut_inflection_of,
        secbody,
        0,
        re.I,
    )

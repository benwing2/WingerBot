...
# col templates
templates_to_rename = {
    "bg-adjective extended of": ["bg-adj form of", "masculine", "extended"],
    "bg-adjective neuter of": ["bg-adj form of", "neuter", "indefinite"],
    "bg-plural count of": ["bg-noun form of", "count"],
    "bg-singular definite object form of": ["bg-noun form of", "singular", "definite", "object"],
    "bg-singular definite subject form of": ["bg-noun form of", "singular", "definite", "subject"],
}
...
def process_text_on_page(index, pagetitle, text):
    ...
    for t in parsed.filter_templates():
        ...
        if tn in templates_to_rename:
            ...
            notes.append(
                "rename {{%s}} to {{%s|%s|%s={{{1}}}}}" % (tn, new_name, "|".join(new_params), main_entry_param)
            )
...
parser = blib.create_argparser(
    "Rename overly specific {{bg-*}} templates to more general ones", include_pagefile=True, include_stdin=True
)

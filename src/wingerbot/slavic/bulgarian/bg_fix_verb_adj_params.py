...
parser = blib.create_argparser(
    "Fix Bulgarian verb/adjective headwords to new format", include_pagefile=True, include_stdin=True
)
...
# default_cats=["Bulgarian verbs", "Bulgarian adjectives"], edit=True, stdin=True)

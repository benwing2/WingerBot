...
noun_stem_types = [
    ...
    "soft",
    "velar-stem",
    "soft third-declension",
    "hard third-declension",
    "fourth-declension",
    "t-stem",
    "n-stem",
]
...
if args.pos == "noun":
    ...
    create_cat(
        "~ with reducible stem",
        [
            "with a reducible stem, where an extra vowel is inserted before the last stem consonant in the nominative singular and/or genitive plural."
        ],
    )
    create_cat(
        "~ with irregular stem",
        ...
        extratext="[[Category:Belarusian irregular nouns]]",
    )
    create_cat(
        "~ with irregular plural stem",

...
request_templates = [
    ...
    ("rfdate", {"desc": "Request for date in quote", "cat": ["Requests for date"], "lang1": "req", "langlang": "no"}),
    (
        "rfdatek",
        {
    ...
    ("rfform", {"desc": "Request for particular form in an inflected form", "lang1": "req", "langlang": "no"}),
    (
        "rfgender",
        {
    ...
    (
        "rfap",
        {
            ...
            "cat": [
                ...
                ("Requests for audio pronunciation from {{{variety}}} in LANG entries", "if |variety= is present"),
            ],
            "lang1": "req",
            "langlang": "depwarn",
        },
    ...
    (
        "MW1913Abbr",
        {"desc": "Link to [[Wiktionary:Abbreviated Authorities in Webster]]", "lang1": "no", "langlang": "no"},
    ),
    (
        "no inline",
        {
    ...
    ("rf-sound example", {"desc": "Request for sound clip", "lang1": "no", "langlang": "no"}),
    (
        "split",
        {
    ...
    # "rfc-sense",
    ("missing template", {"desc": "Request for template creation", "lang1": "no", "langlang": "no"}),
    (
        "Nuttall",
        {
    ...
    ("oed1923", {"desc": "Notice of incorporation of text from first-edition OED", "lang1": "no", "langlang": "no"}),
    # "rfc-auto",
    # "rfc-header",
    (
        "stub entry",
    ...
    (
        "Webster 1913",
        {"desc": "Note of incorporation of text from 1913 Webster dictionary", "lang1": "no", "langlang": "no"},
    ),
]

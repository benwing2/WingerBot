...
def process_text_on_page(p):
    ...
    for t in parsed.filter_templates():
        ...
        tn = tname(t)
        if (
            tn in wikipedia_box_templates
            or tn in interproject_templates_lang_in_1
            or tn in interproject_templates_lang_in_lang
        ):
...
parser = blib.create_argparser("Eliminate dab= in interproject templates")

...
parser = blib.create_argparser(
    "Fix calls to {{la-decl-gerund}} to include final -um", include_pagefile=True, include_stdin=True
)
args = parser.parse_args()
start, end = blib.parse_start_end(args.start, args.end)

blib.do_pagefile_cats_refs(
    args, start, end, process_text_on_page, default_refs=["Template:la-decl-gerund"], edit=True, stdin=True
)

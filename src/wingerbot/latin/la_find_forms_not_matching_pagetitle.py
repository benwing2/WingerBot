...
parser = blib.create_argparser("Check for bad Latin forms", include_pagefile=True, include_stdin=True)
args = parser.parse_args()
start, end = blib.parse_start_end(args.start, args.end)

blib.do_pagefile_cats_refs(
    args, start, end, process_text_on_page, stdin=True, only_lang="Latin", default_cats=["Latin non-lemma forms"]
)
